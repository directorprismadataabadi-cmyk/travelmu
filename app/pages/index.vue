...
useHead({
  title: 'TravelMu - Book Flights, Hotels & Experiences | Best Travel Deals',
  meta: [
    { name: 'description', content: "Discover amazing travel deals on flights, hotels, and experiences. Book your dream vacation with TravelMu - Indonesia's trusted travel platform." },
    { name: 'keywords', content: 'travel, flights, hotels, vacation, Indonesia, Bali, booking, experiences, tours' },
    { property: 'og:title', content: 'TravelMu - Book Flights, Hotels & Experiences' },
  ...
  script: [
    {
      ...
      children: JSON.stringify({
        ...
        "@type": "WebSite",
        "name": "TravelMu",
        "url": "https://travelmu.com",
        "potentialAction": {
          "@type": "SearchAction",
          "target": "https://travelmu.com/search?q={search_term_string}",
...
// Demo reviews
const reviews = ref([
  { id: '1', name: 'Sarah M.', avatar: 'https://i.pravatar.cc/100?img=1', rating: 5, text: 'Amazing experience booking through TravelMu! Got great deals on my Bali trip.', trip: 'Bali Adventure' },
