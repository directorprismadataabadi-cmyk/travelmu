...
import { useTravelMuStore } from '~/store/travelmu';
...
useHead({
  title: 'Login | TravelMu',
});

const userStore = useUserStore();
const travelMuStore = useTravelMuStore();
...
const handleLogin = async () => {
  ...
  try {
    // Demo login - in production, use actual API
    ...
    const redirectUrl = travelMuStore.getAndClearRedirectUrl();
  ...
  <div class="min-h-screen flex">
    ...
    <div class="flex-1 flex items-center justify-center px-4 py-20 bg-white">
      <div class="w-full max-w-md">
        ...
        <p class="text-slate-500 mb-8">
          ...
          <NuxtLink to="/register" class="font-medium hover:underline" style="color: #FF5A5F;">Sign up</NuxtLink>
        </p>
        ...
        <form @submit.prevent="handleLogin" class="space-y-5">
          <div>
            ...
            <div class="relative">
              ...
              <input 
                ...
                class="w-full pl-11 pr-4 py-3 rounded-xl border border-slate-200 focus:border-coral-500 focus:ring-2 focus:ring-coral-500/20 outline-none transition-all"
              />
            </div>
          </div>
          ...
          <div>
            ...
            <div class="relative">
              ...
              <input 
                ...
                placeholder="••••••••"
                class="w-full pl-11 pr-12 py-3 rounded-xl border border-slate-200 focus:border-coral-500 focus:ring-2 focus:ring-coral-500/20 outline-none transition-all"
              />
              <button 
                type="button"
          ...
          <div class="flex items-center justify-between">
            <label class="flex items-center gap-2 cursor-pointer">
              <input type="checkbox" v-model="form.rememberMe" class="rounded" style="accent-color: #FF5A5F;" />
              <span class="text-sm text-slate-600">Remember me</span>
            </label>
            <a href="#" class="text-sm font-medium hover:underline" style="color: #FF5A5F;">Forgot password?</a>
          </div>
    ...
    <div class="hidden lg:block lg:w-1/2 relative">
      ...
      <div class="absolute bottom-0 left-0 right-0 p-12">
        <h2 class="text-4xl font-bold text-white mb-4">Ready for your next adventure?</h2>
        <p class="text-white/80 text-lg">Log in to access exclusive deals and manage your bookings.</p>
      </div>
    </div>
  </div>
</template>
