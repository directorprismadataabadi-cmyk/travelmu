...
// Navigation items
const navItems = [
  { name: 'Flights', icon: 'fa-solid fa-plane', href: '/flights' },
  { name: 'Hotels', icon: 'fa-solid fa-hotel', href: '/hotels' },
  { name: 'Experiences', icon: 'fa-solid fa-compass', href: '/experiences' },
  { name: 'Rentals', icon: 'fa-solid fa-car', href: '/rentals' },
  { name: 'Packages', icon: 'fa-solid fa-gift', href: '/packages' },
];
...
<template>
  <div class="travelmu-layout min-h-screen bg-slate-50">
    <!-- Navbar -->
    <header 
      :class="[
    ...
    <footer class="bg-slate-900 text-white pt-20 pb-8">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-8 pb-12 border-b border-slate-800">
          ...
          <div class="col-span-2">
            <div class="flex items-center gap-3 mb-6">
              ...
              <span class="text-2xl font-bold">Travel<span class="text-coral-500">Mu</span></span>
            </div>
          ...
          <div>
            ...
            <ul class="space-y-2.5">
              <li><a href="/flights" class="text-slate-400 hover:text-coral-400 text-sm transition-colors">Flights</a></li>
              <li><a href="/hotels" class="text-slate-400 hover:text-coral-400 text-sm transition-colors">Hotels</a></li>
              <li><a href="/experiences" class="text-slate-400 hover:text-coral-400 text-sm transition-colors">Experiences</a></li>
              <li><a href="/rentals" class="text-slate-400 hover:text-coral-400 text-sm transition-colors">Car Rentals</a></li>
              <li><a href="/packages" class="text-slate-400 hover:text-coral-400 text-sm transition-colors">Packages</a></li>
            </ul>
          </div>
        ...
        <div class="pt-8 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p class="text-slate-500 text-sm">© {{ new Date().getFullYear() }} TravelMu. All rights reserved.</p>
