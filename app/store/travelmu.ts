// store/travelmu.ts
// Pinia store for TravelMu state management
...
interface TravelMuState {
    // User
    user: TravelMuUser | null;
...
export const useTravelMuStore = defineStore('travelmu', {
    state: (): TravelMuState => ({
        user: null,
    ...
    actions: {
        // User Actions
        setUser(user: TravelMuUser | null) {
            this.user = user;
        ...
        setSearchTab(tab: TravelMuState['searchTab']) {
            this.searchTab = tab;
        },
    },
});
